package com.innaval.searchingithub.presentation.user.search
...
import com.innaval.searchingithub.core.extensions.navigateWithAnimations
import com.innaval.searchingithub.core.utils.Status
import com.innaval.searchingithub.databinding.FragmentUserBinding
    ...
    private fun initListeners() {
        adapter.onClickListener = { userModel ->
            val directions = UserFragmentDirections
                .actionUserFragmentToUserInfoFragment(
                    userModel = userModel,
                )
