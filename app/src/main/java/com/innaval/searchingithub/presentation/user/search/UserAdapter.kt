...
import com.innaval.searchingithub.databinding.ItemUserBinding
import com.innaval.searchingithub.domain.model.UserModel

class UserAdapter(
    var onClickListener: (userModel: UserModel) -> Unit = {},
) : androidx.recyclerview.widget.ListAdapter<UserModel, UserAdapter.UsersViewHolder>(DIFF_CALLBACK) {
